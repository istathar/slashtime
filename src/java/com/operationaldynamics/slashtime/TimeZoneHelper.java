...
/**
 * This Class is only a helper class... it provides you with a method to
 * determine the current user's timezone in a quite complicated way...
 * @author Andrew Cowie
...
public class TimeZoneHelper {    
     ...
     * suppose.
     */
    public static final String TZDIR         = "/usr/share/zoneinfo";

    
    /**
     * Determines and returns the timezone of the current user.
    ...
    public static String getUserTimeZone() {
        ...
        if (localtime.exists()) {                    
            // Another one of my less-brilliant ideas to determine wheter localtime
